            ...
            <table  class="table table-striped table-bordered" style="width: 90%" id="statusTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%=sta.getId()%></td>
                        <td><%=sta.getName()%></td>
                        <td><a class="btn btn-danger"  href="EmployeeServlet?action=delete&id=<%=sta.getId()%>">Delete</a>
                            <a class="btn btn-primary" href=# data-toggle="modal" data-target="#update<%=sta.getId()%>" >Update</a>
                        </td>
                    </tr>
                    <%}
                    }%>
